...
import { devProfile, footerLinks, socialMedia } from "../constants"
    ...
    <footer className="max-container">
      ...
      flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          text-white-400 sm:max-w-sm">
            Get ethnic indian footwear ready for the new term at your nearest stores.
            ...
            <div key={section.title}>
              ...
              <ul>
                {section.links.map((link) => (
                  <li key={link.name}
                    className="mt-3 text-montserrat text-white-400 text-base
      ...
      max-sm:flex-col max-sm:items-center">
        ...
        gap-2 font-montserrat cursor-pointer">
          ...
          />
          <p>Made by 
            <a href={devProfile.profileLink}> {devProfile.name}</a>.
          </p>
        </div>
        <p className="font-montserrat cursor-pointer">No Terms & Conditions</p>
      </div>
    </footer>
  )
}
